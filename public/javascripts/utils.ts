...
"story" (the story itself, it should be around one paragraph long), "description" (one sentence
 description of story), "firstOpt", "secondOpt", "thirdOpt" (three possible choices for next chapter 
 of the game) and "gameEnded" (boolean which marks if story is done, should be true when 5th chapter is 
 reached). Also please format JSON in proper way so I can parse it later in my code. Some choices can 
 lead to early ending of the game.`
    }
}